...
* [API CommonUtil 공통 util](#API-CommonUtil)  
* [API CommonCode 공통](#API-CommonCode)  
...
---------------------------------
<p float="left">
  <img src="./img/interface_commonutil_1.png" width="270" height="600"/>  
...
---------------------------------
<p float="left">
  <img src="./img/interface_commoncode_1.png" width="270" height="600"/>  
  <img src="./img/interface_commoncode_2.png" width="490" height="520"/>  
</p>
...
현재는 S를 받으면 선택을, A를 데이터 처음에 붙여서 넘겨주고 있다.  
